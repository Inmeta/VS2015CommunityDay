...
* master: Contains the most recent code for the non-K stuff
* K-1:  Contains the stuff for the Project K, ASP.NET vNext type of samples.
* Codecracker:  Samples for using Codecracker analyzers.  [See Codecracker open source project](https://github.com/code-cracker/code-cracker)

Some other branches with some special things, go look it up.
...
![Settings image](CSharp\images\debug1.png)
